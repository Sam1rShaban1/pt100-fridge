...
// ===================== WiFi =====================
#define WIFI_SSID      "VezeSharri"
#define WIFI_PASSWORD  "VezeSharri000"

// ===================== Device identity (set per device) =====================
#define DEVICE_ID      "fridge-001"
#define GROUP          "zone_a"
#define FW_VERSION     "1.0.1"   // bump this on every firmware release
...
#define MQTT_BROKER    "192.168.0.126"
...
#define OTA_BASE_URL   "http://192.168.0.126:8010"
#define OTA_POLL_MS    3600000UL   // check the manifest once per hour

// ===================== Sensors =====================
#define PUBLISH_MS     1000UL
